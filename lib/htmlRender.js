const htmlRender = (teamMates) => {
    ...
    for (let i = 0; i < teamMates.length; i++) {
        ...
        <div class="card-body">
          ...
          <p class="card-text">Role: ${emp.getRole()}</p>
    ...
    //!! talk to my ssm and see if they can help me with some advice give me more sessions just depends what they think is best for the situation and see what they can do
    //!! student success manager Corrine
